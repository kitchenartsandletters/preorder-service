...
## Stack (orientation)
- FastAPI, Python 3.13. Supabase (schema `preorder`) holds the read models and state; Shopify Admin API 2025-10.
...
- Tests are plain `pytest` under `tests/` (e.g. `test_week_reconcile.py`, `test_week_migration.py`).
